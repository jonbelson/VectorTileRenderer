...
inline const std::string& Tile_GeomType_Name(Tile_GeomType value) {
  return ::google::protobuf::internal::NameOfDenseEnum<Tile_GeomType_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool Tile_GeomType_Parse(absl::string_view name, Tile_GeomType* value) {
...
/* @@protoc_insertion_point(class_definition:vector_tile.Tile) */ {
 ...
 public:
  ...
  static inline const ::google::protobuf::EnumDescriptor* GeomType_descriptor() {
