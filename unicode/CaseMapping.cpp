...
namespace unicode::casemapping
{
	...
	static constexpr auto LowerToUpper = std::to_array<Entry>({
		...
		{ 0x0062, 0x0042 },   // LATIN SMALL LETTER B
		{ 0x0063, 0x0043 },   // LATIN SMALL LETTER C
		{ 0x0064, 0x0044 },   // LATIN SMALL LETTER D
		{ 0x0065, 0x0045 },   // LATIN SMALL LETTER E
		{ 0x0066, 0x0046 },   // LATIN SMALL LETTER F
		{ 0x0067, 0x0047 },   // LATIN SMALL LETTER G
		{ 0x0068, 0x0048 },   // LATIN SMALL LETTER H
		{ 0x0069, 0x0049 },   // LATIN SMALL LETTER I
		{ 0x006A, 0x004A },   // LATIN SMALL LETTER J
		{ 0x006B, 0x004B },   // LATIN SMALL LETTER K
		{ 0x006C, 0x004C },   // LATIN SMALL LETTER L
		{ 0x006D, 0x004D },   // LATIN SMALL LETTER M
		{ 0x006E, 0x004E },   // LATIN SMALL LETTER N
		{ 0x006F, 0x004F },   // LATIN SMALL LETTER O
		{ 0x0070, 0x0050 },   // LATIN SMALL LETTER P
		{ 0x0071, 0x0051 },   // LATIN SMALL LETTER Q
		{ 0x0072, 0x0052 },   // LATIN SMALL LETTER R
		{ 0x0073, 0x0053 },   // LATIN SMALL LETTER S
		{ 0x0074, 0x0054 },   // LATIN SMALL LETTER T
		{ 0x0075, 0x0055 },   // LATIN SMALL LETTER U
		{ 0x0076, 0x0056 },   // LATIN SMALL LETTER V
		{ 0x0077, 0x0057 },   // LATIN SMALL LETTER W
		{ 0x0078, 0x0058 },   // LATIN SMALL LETTER X
		{ 0x0079, 0x0059 },   // LATIN SMALL LETTER Y
		{ 0x007A, 0x005A },   // LATIN SMALL LETTER Z
	...
	//static constexpr std::array<Entry, 1488> UpperToLower = {{
	static constexpr auto UpperToLower = std::to_array<Entry>({
		...
		{ 0x0059, 0x0079 },   // LATIN CAPITAL LETTER Y    { 0x005A, 0x007A },   // LATIN CAPITAL LETTER Z
		...
		{ 0xA7CE, 0xA7CF },   // LATIN CAPITAL LETTER PHARYNGEAL VOICED FRICATIVE
		{ 0xA7D0, 0xA7D1 },   // LATIN CAPITAL LETTER CLOSED INSULAR G
		{ 0xA7D2, 0xA7D3 },   // LATIN CAPITAL LETTER DOUBLE THORN
		{ 0xA7D4, 0xA7D5 },   // LATIN CAPITAL LETTER DOUBLE WYNN
		...
		{ 0x16EA0, 0x16EBB },   // BERIA ERFE CAPITAL LETTER ARKAB
		{ 0x16EA1, 0x16EBC },   // BERIA ERFE CAPITAL LETTER BASIGNA
		{ 0x16EA2, 0x16EBD },   // BERIA ERFE CAPITAL LETTER DARBAI
		{ 0x16EA3, 0x16EBE },   // BERIA ERFE CAPITAL LETTER EH
		{ 0x16EA4, 0x16EBF },   // BERIA ERFE CAPITAL LETTER FITKO
		{ 0x16EA5, 0x16EC0 },   // BERIA ERFE CAPITAL LETTER GOWAY
		{ 0x16EA6, 0x16EC1 },   // BERIA ERFE CAPITAL LETTER HIRDEABO
		{ 0x16EA7, 0x16EC2 },   // BERIA ERFE CAPITAL LETTER I
		{ 0x16EA8, 0x16EC3 },   // BERIA ERFE CAPITAL LETTER DJAI
		{ 0x16EA9, 0x16EC4 },   // BERIA ERFE CAPITAL LETTER KOBO
		{ 0x16EAA, 0x16EC5 },   // BERIA ERFE CAPITAL LETTER LAKKO
		{ 0x16EAB, 0x16EC6 },   // BERIA ERFE CAPITAL LETTER MERI
		{ 0x16EAC, 0x16EC7 },   // BERIA ERFE CAPITAL LETTER NINI
		{ 0x16EAD, 0x16EC8 },   // BERIA ERFE CAPITAL LETTER GNA
		{ 0x16EAE, 0x16EC9 },   // BERIA ERFE CAPITAL LETTER NGAY
		{ 0x16EAF, 0x16ECA },   // BERIA ERFE CAPITAL LETTER OI
		{ 0x16EB0, 0x16ECB },   // BERIA ERFE CAPITAL LETTER PI
		{ 0x16EB1, 0x16ECC },   // BERIA ERFE CAPITAL LETTER ERIGO
		{ 0x16EB2, 0x16ECD },   // BERIA ERFE CAPITAL LETTER ERIGO TAMURA
		{ 0x16EB3, 0x16ECE },   // BERIA ERFE CAPITAL LETTER SERI
		{ 0x16EB4, 0x16ECF },   // BERIA ERFE CAPITAL LETTER SHEP
		{ 0x16EB5, 0x16ED0 },   // BERIA ERFE CAPITAL LETTER TATASOUE
		{ 0x16EB6, 0x16ED1 },   // BERIA ERFE CAPITAL LETTER UI
		{ 0x16EB7, 0x16ED2 },   // BERIA ERFE CAPITAL LETTER WASSE
		{ 0x16EB8, 0x16ED3 },   // BERIA ERFE CAPITAL LETTER AY
	...
	[[nodiscard]] uint32_t ToUpper(uint32_t codePoint)
	{
        ...
        if (it != LowerToUpper.end() && it->first == codePoint)
        {
            return it->second;
        }
	...
	[[nodiscard]] uint32_t ToLower(uint32_t codePoint)
	{
        ...
        if (it != UpperToLower.end() && it->first == codePoint)
        {
            return it->second;
        }
	...
	[[nodiscard]] std::string ToLower(std::string_view sv)
	{
		...
		auto outputUtf32 = ToLower(inputUtf32);
